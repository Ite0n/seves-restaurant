...
const fr: LocaleData = {
  ...
  tastingCourses: [
    { chapter: "Jardin", title: "Amuse & Jardin", desc: "Tomate Sèves, labné, herbes des plates-bandes de la terrasse.", image: "/images/menu/tomate-seves.webp" },
    { chapter: "Mer", title: "De la Côte", desc: "Crudo du jour, ceviche de pêche méditerranéenne.", image: "/images/menu/crudo-du-jour.webp" },
    { chapter: "Feu", title: "Braises & Fumée", desc: "Rôti d'héritage, légumes grillés, réduction de jus.", image: "/images/menu/supreme-rotie.webp" },
    { chapter: "Terroir", title: "Terroir", desc: "Entrecôte Wagyu, pithivier d'agneau, burghul revisité.", image: "/images/menu/entrecote.webp" },
    { chapter: "Cave", title: "Interlude", desc: "Service du sommelier — un pont entre le salé et le sucré.", image: "/images/interior-winecart-dusk.webp" },
    { chapter: "Sucré", title: "Finale", desc: "Tarte aux noix, pavlova, mille-feuille — notes de grâce.", image: "/images/menu/nutty-tarte.webp" },
  ],
  faq: [
  ...
  gifts: [
    { id: "tasting-gift", title: "Le Voyage Sèves", description: "Chèque-cadeau pour notre menu dégustation 14 services — valable 12 mois.", price: "185 $", image: "/images/brand-monument-sign.webp" },
    { id: "chefs-table-gift", title: "Table du Chef", description: "Six places au pass — une soirée inoubliable pour deux.", price: "440 $", image: "/images/interior-dining-banquette.webp" },
    { id: "private-dining-gift", title: "Salle Privée", description: "Le Salon du Jardin — menu sur mesure jusqu'à 14 convives.", price: "Sur demande", image: "/images/interior-banquette-garden.webp" },
  ],
  cellar: {
  ...
  gallery: [
    { src: "/images/interior-dining-banquette.webp", alt: "Salle principale aux banquettes en velours émeraude", span: "col-span-2 row-span-2 md:col-span-6 md:row-span-2" },
    { src: "/images/interior-feather-art.webp", alt: "Sculpture de plumes rétroéclairée et bar", span: "col-span-1 row-span-1 md:col-span-3" },
    { src: "/images/bar-bonsai-night.webp", alt: "Bar avec bonsaï et spiritueux sélectionnés", span: "col-span-1 row-span-1 md:col-span-3" },
    { src: "/images/interior-pendant-room.webp", alt: "Salle à manger sous des suspensions en cascade", span: "col-span-2 row-span-1 md:col-span-6" },
    { src: "/images/exterior-firewater-city.webp", alt: "Terrasse avec braseros et jeux d'eau", span: "col-span-1 row-span-1 md:col-span-4 md:row-span-2" },
    { src: "/images/exterior-terrace-night.webp", alt: "Terrasse-jardin au crépuscule", span: "col-span-1 row-span-1 md:col-span-4" },
    { src: "/images/interior-banquette-windows.webp", alt: "Banquettes face aux fenêtres au crépuscule", span: "col-span-1 row-span-1 md:col-span-4" },
    { src: "/images/interior-winecart-dusk.webp", alt: "Service des vins à l'heure dorée", span: "col-span-2 row-span-1 md:col-span-5" },
    { src: "/images/interior-bonsai-window.webp", alt: "Centre de table bonsaï sur marbre", span: "col-span-1 row-span-1 md:col-span-4" },
    { src: "/images/bar-stools-night.webp", alt: "Le bar après la tombée de la nuit", span: "col-span-1 row-span-1 md:col-span-3" },
    { src: "/images/interior-banquette-garden.webp", alt: "Banquette avec vue sur le jardin", span: "col-span-1 row-span-1 md:col-span-4" },
  ],
  walkthrough: {
    label: "L'expérience",
